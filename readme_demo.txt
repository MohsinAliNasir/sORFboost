...
As yoou can see I am using windows so I will open the cmd as administrator
so you can see I already have installed my python in my system 
you can see the version 3.10.11
You need to instal xgboost undet python by the command
...
so for this purpose we can make a folder in documents
